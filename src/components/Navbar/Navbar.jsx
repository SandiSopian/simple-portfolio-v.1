    ...
    <>
      ...
      <div className="block md:hidden">
        <div className="flex flex-row mx-auto py-4 px-4 gap-3">
          <div className="py-2 px-4 bg-white rounded-lg shadow-lg text-sm cursor-pointer hover-scale" onClick={handleCopy}>
          ...
          <div className="py-2 px-4 bg-white rounded-lg shadow-lg text-sm hover-scale">
            <a href={cv}>CV</a>
          </div>
        </div>
      </div>
